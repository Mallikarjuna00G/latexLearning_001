...
% The complete code using petri library
\documentclass[tikz, border=10pt]{standalone}

\usepackage{tikz}
\usetikzlibrary{arrows.meta, petri, positioning, decorations.pathmorphing, fit, backgrounds}
...
\begin{document}
	\begin{tikzpicture}[
		...
		\draw [->, shorten >=1mm, thick, decorate, decoration={snake, amplitude=0.4mm, segment length=2mm, pre=moveto, pre length=1mm, post length=2mm}]
			(r1) -- (r2)
