...
## [1.4.0] - 2026-05-23
### Added
- Completed Chapter 3 ("Tutorial: A Petri-Net for Hagen") of the TikZ & PGF manual.
- Covered the complete code construction for the Petri-net (section 3.14).

## [1.3.6] - 2026-05-23
### Added
- Continued Chapter 3 ("Tutorial: A Petri-Net for Hagen") of the TikZ & PGF manual.
- Covered adding labels next to lines (section 3.11).
- Covered adding the snaked line & multi-line text (section 3.12).
- Covered using layers for background rectangles (section 3.13).

## [1.3.5] - 2026-05-23
### Added
- Continued Chapter 3 ("Tutorial: A Petri-Net for Hagen") of the TikZ & PGF manual.
- Covered placing nodes using relative placements (section 3.8).
- Covered adding labels next to nodes (section 3.9).
- Covered connecting nodes (section 3.10).

## [1.3.4] - 2026-05-23
### Added
- Continued Chapter 3 ("Tutorial: A Petri-Net for Hagen") of the TikZ & PGF manual.
- Covered using styles in TikZ (section 3.5).
- Covered configuring node size (section 3.6).
- Covered naming nodes for coordinate references (section 3.7).
